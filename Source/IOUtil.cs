...
namespace ChangeMirror
{
    ...
    static class IOUtil
    {
        public static ColorPresetsDTO LoadColorPresets(ColorPresetType type)
        {
            ...
            {
                Messages.Message("ChangeMirror.ProblemLoadingPreset".Translate() + " " + type + ".", MessageTypeDefOf.SilentInput);
        ...
        public static void SaveColorPresets(ColorPresetType type, ColorPresetsDTO presetsDto)
        {
            ...
            {
                Messages.Message("ChangeMirror.ProblemSavingPreset".Translate() + " " + type + ".", MessageTypeDefOf.SilentInput);
        ...
        private static bool TryGetDirectoryName(out string path)
        {
            ...
            {
                Log.Error("ChangeMirror: Failed to get folder name - " + ex);
                path = null;
                return false;
            }
        }
